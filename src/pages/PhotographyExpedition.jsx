  ...
  return (
    <div style={{ minHeight: "100vh", background: `linear-gradient(160deg, ${bg} 0%, #120f14 50%, ${bg} 100%)`, color: text, fontFamily: "'Cormorant Garamond', Georgia, serif", overflowX: "hidden" }}>
      ...
      <div style={{
        ...
        background: "linear-gradient(to bottom, rgba(9,8,10,0.2) 0%, rgba(9,8,10,0.55) 55%, rgba(9,8,10,0.97) 100%), url('/images/packages/panchachuli-real.jpg') center/cover no-repeat",
      }}>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "72px 32px" }}>
        ...
        <motion.section initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} style={{ marginBottom: 80 }}>
          ...
          <div style={{ padding: "20px 28px", borderLeft: `3px solid ${amber}`, background: `${amber}0a`, maxWidth: 640 }}>
